...
namespace MCP23008_I2CIO7R1G5V1
{
    public partial class frmI2CIO7R1G5V1 : Form
    {
        byte currentOutputStatus = 0;

        CommInterface CommObj = null;
        public frmI2CIO7R1G5V1()
        {
            InitializeComponent();
        }
        ...
        private void Init()
        {
            try
            {
                ...
                CommObj.Send(new byte[] { addr, 0, 254}, 0);
        ...
        private void UpdateStatus()
        {
            ...
            lbInput2.Text = GetStatusString(currentOutputStatus, 1);
            lbInput3.Text = GetStatusString(currentOutputStatus, 2);
            lbInput4.Text = GetStatusString(currentOutputStatus, 3);
    ...
    public class MyGUI : GuiInterface
    {
        ...
        {
            frmI2CIO7R1G5V1 frm = new frmI2CIO7R1G5V1();
            frm.Attach(com);
            frm.ShowDialog();
        }
    }
