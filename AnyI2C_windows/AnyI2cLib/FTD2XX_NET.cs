...
** FTD2XX_NET.cs
**
** Copyright ?2009-2014 Future Technology Devices International Limited
**
...
namespace FTD2XX_NET
{
	...
	public class FTDI
	{
        public bool LoadLibrarySuccess = false; // flag for load library success
		...
		public FT_STATUS GetDeviceList(FT_DEVICE_INFO_NODE[] devicelist)
		{
			...
			else
			{
				...
				if (pFT_GetDeviceInfoDetail == IntPtr.Zero)
				{
                    ...
                    Debug.WriteLine("Failed to load function FT_GetDeviceInfoListDetail.");
				}
			}
			return ftStatus;
		}
